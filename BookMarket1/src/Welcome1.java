...
public class Welcome1 {
	...
	public static void main(String[] args) {
		...
		//프로젝트 4-2 메뉴 선택 종료하기
		//프로젝트 4-2-1 메뉴 선택 계속하기 : 선택할 메뉴를 보여주는 코드를 감싸도록 반복문을 작성한다.
		boolean quit = false; //종료 여부를 설정하는 변수 quit
		//quit 변수가 true일 때까지 계속 반복
		while(!quit) { //while문 시작
			...
			if(n < 1 || n > 8) {
				...
				case 1 :
					...
					//프로젝트 4-1-2 고객 정보 출력
					//선택한 메뉴 번호가 1일때 키보드로 입력된 고객명과 연락처를 출력한다.
				...
				case 8 :
					...
					//프로젝트 4-2-2 메뉴 선택 종료하기
					quit = true; //quit에 true값을 줘서 반복문을 종료 조건을 충족 시킨다 (반복문을 종료한다.)
					break;
				} //end switch
			} //end else
		} //end while
